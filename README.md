...
[![Skills](https://img.shields.io/badge/skills-45-d946ef)](#skill-inventory)
...
```bash
exceptd doctor --signatures            # verify Ed25519 chains (45/45 expected)
...
exceptd collect <playbook>            Walk cwd + invoke the companion collector
                                      ...
                                      14/27 playbooks have collectors; the rest
