...
[![ATLAS](https://img.shields.io/badge/MITRE%20ATLAS-v2026.08-d946ef)](https://atlas.mitre.org)
[![ATT&CK](https://img.shields.io/badge/MITRE%20ATT%26CK-v19.2-d946ef)](https://attack.mitre.org)
...
AI/ML attack surface assessment mapped to MITRE ATLAS v2026.08 with explicit gap flags. Covers prompt injection as enterprise RCE (CVE-2025-53773 CVSS 7.8, 85%+ bypass rate against SOTA defenses), MCP supply chain RCE (CVE-2026-30615, zero user interaction, 150M+ downloads), RAG exfiltration, model poisoning, AI-assisted exploit development (41% of 2025 zero-days), credential theft acceleration (160% increase).
...
**Framework lag is measured in months.** MITRE ATLAS v2026.08 (May 2026) is the most current AI threat framework available. It still lags real exploitation by 3-6 months. NIST AI RMF lags by years. ISO 27001:2022 has no AI-specific controls. These skills explicitly flag every place where framework coverage ends and real attacker capability begins.

**AI changed the exploit development timeline.** An AI system discovered Copy Fail in approximately one hour. 41% of 2025 zero-days involved AI-assisted reverse engineering on the attacker side. The time between vulnerability introduction and reliable exploitation is compressing faster than patch management processes can adapt. Risk scoring must reflect this.
