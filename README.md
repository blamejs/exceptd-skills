...
[![Skills](https://img.shields.io/badge/skills-47-d946ef)](#skill-inventory)
...
```bash
exceptd doctor --signatures            # verify Ed25519 chains (47/47 expected)
...
exceptd collect <playbook>            Walk cwd + invoke the companion collector
                                      ...
                                      14/29 playbooks have collectors; the rest
