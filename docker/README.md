...
reproduce CI's Linux + Node 24.21.0 LTS environment locally before
pushing.
...
|------------------|----------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------|
| `predeploy`      | Runs `npm run predeploy` against the repo state as-is.                                              | Day-to-day: "does my change break a gate on Linux/Node 24.21.0?"             |
...
The base image tag (`node:24.21.0-alpine3.23`) is pinned to match the
