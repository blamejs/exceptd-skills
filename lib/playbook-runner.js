...
function analyze(playbookId, directiveId, detectResult, agentSignals = {}, runOpts = {}) {
  ...
  for (const ec of an.escalation_criteria || []) {
    if (evalCondition(ec.condition, { ...agentSignals, ...evalCtxRoot, rwep: adjustedRwep, blast_radius_score: blastRadiusScore, theater_verdict: theaterVerdict, compliance_theater_check: result.compliance_theater_check, analyze: result, finding: findingShape }, playbook)) {
