 ...
 * the on-disk key order of the top-level object, (c) line endings or BOM.
 *
 *   1. Clone, delete manifest_signature.
 *   2. Stringify with the top-level keys sorted lexicographically;
 *      nested structures keep insertion order (skills entries already
 *      follow a stable convention, and per-skill fields are
 *      schema-anchored).
