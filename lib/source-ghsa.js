...
// Cap the streamed response so a hijacked DNS / compromised CDN / MITM serving
// api.github.com can't stream unbounded bytes into RAM. A 50-advisory page is
// well under a MB; 16 MB is generous headroom. Symmetric with the JSON cap
// getJsonOnce enforces in lib/refresh-network.js and the OSV poller's cap.
// Tunable via EXCEPTD_GHSA_RESPONSE_CAP_BYTES for future API growth.
