...
**Note on ATLAS coverage.** AML.T0010 (AI Supply Chain Compromise) is the closest current ATLAS v2026.08 mapping for AI-augmented-HMI threats; it does not specifically cover prompt-injection-as-operator-deception in a control room. This is a tracked ATLAS gap — see `forward_watch`.
