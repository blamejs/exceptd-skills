...
The TTP source-of-truth is `data/atlas-ttps.json` (MITRE ATLAS v2026.08, May 2026) supplemented by ATT&CK Enterprise. No orphaned controls: no exception in this skill is granted without an enumerated residual-TTP set; an exception with no listed residual is theater.
