...
Descriptions sourced verbatim from `data/atlas-ttps.json` (ATLAS v2026.05, released 2026-05-08). Partial-coverage controls from `data/framework-control-gaps.json`.
