...
Descriptions sourced verbatim from `data/atlas-ttps.json` (ATLAS v2026.06, released 2026-06-30). Partial-coverage controls from `data/framework-control-gaps.json`.
