...
|---|---|---|---|
| AML.T0010 | AI Supply Chain Compromise | Direct: malicious model, malicious MCP server, malicious ML library — the umbrella attack class for AI artifact compromise | ATLAS v2026.08 classifies the attack; no framework mandates the cryptographic control that would detect it at load |
