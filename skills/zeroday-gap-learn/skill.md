...
| `data/atlas-ttps.json` (MITRE ATLAS v2026.08) | The AI/ML TTP taxonomy. Attack-vector extraction maps the CVE's mechanism to an ATLAS ID (e.g., AML.T0096 for SesameOp AI-as-C2). |
...
- MITRE ATLAS v2026.08 (which TTP? Is it covered?)
