...
test("BUG-2026-NIGHTMARE-ECLIPSE-UNDEFEND is present and well-formed in the catalog", () => {
  const e = CATALOG["BUG-2026-NIGHTMARE-ECLIPSE-UNDEFEND"];
  assert.ok(e, "BUG-2026-NIGHTMARE-ECLIPSE-UNDEFEND must exist in data/cve-catalog.json");
