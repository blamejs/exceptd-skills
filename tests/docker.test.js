 ...
 * contributors a local Linux+Node-24.19.0 reproduction of CI. The most
...
test("Dockerfile Node version matches the CI workflow Node version", () => {
  ...
  assert.ok(
    ciMatch,
    "ci.yml must declare an exact node-version: '24.19.0'-style version"
  );
...
// ---- routed from j-docker-readme-targets ----
require("node:test").describe("j-docker-readme-targets", () => {
