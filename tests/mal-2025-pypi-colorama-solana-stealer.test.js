...
test("MAL-2025-PYPI-COLORAMA-SOLANA-STEALER is present and well-formed in the catalog", () => {
  const e = CATALOG["MAL-2025-PYPI-COLORAMA-SOLANA-STEALER"];
  assert.ok(e, "MAL-2025-PYPI-COLORAMA-SOLANA-STEALER must exist in data/cve-catalog.json");
