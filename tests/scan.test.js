...
/**
 * Subject suite for the `exceptd scan` orchestrator-passthrough verb.
 *
...
describe('cli-flag-and-envelope-hardening.test.js', () => {
  ...
  // currency emits a scheduler log line before the envelope; the JSON
  // envelope is the LAST stdout line. scan is single-line but reuse the
  // tolerant reader for symmetry.
